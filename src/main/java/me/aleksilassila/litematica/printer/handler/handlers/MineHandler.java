...
public class MineHandler extends ClientPlayerTickHandler {
        ...
        for (int sectionY = maxSection; sectionY >= minSection; sectionY--) {
            ...
            for (int chunkX = minChunkX; chunkX <= maxChunkX; chunkX++) {
                for (int chunkZ = minChunkZ; chunkZ <= maxChunkZ; chunkZ++) {
                    ...
                    int foundY = findBreakableInSection(chunk, section, sectionY, chunkX, chunkZ, selection);
    ...
    private int findBreakableInSection(LevelChunk chunk, LevelChunkSection section, int sectionY,
                                       int chunkX, int chunkZ, PrinterBox selection) {
